...
//webrtc.connection.setInfo("webReceiver", webrtc.connection.connection.id, 'receiver', 'janus');
webrtc.setInfo("webReceiver", webrtc.connection.connection.id, 'receiver', 'janus');
...
webrtc.on('videoAdded', function (video, peer) {
   ...
   // if (peer.type == "video" && peer.id == targetId) {
   if  (peer.type == "video") {
